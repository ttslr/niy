...
get_sample_in('src/train-images-idx3-ubyte.gz', "train_in.smpl")
get_sample_out("src/train-labels-idx1-ubyte.gz", "train_out.smpl")

get_sample_in('src/t10k-images-idx3-ubyte.gz', "test_in.smpl")
get_sample_out("src/t10k-labels-idx1-ubyte.gz", "test_out.smpl")
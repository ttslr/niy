...
add_data_batch('files/data_batch_1')
add_data_batch('files/data_batch_2')
add_data_batch('files/data_batch_3')
add_data_batch('files/data_batch_4')
add_data_batch('files/data_batch_5')
...
add_data_batch('files/test_batch')

...
| BiasFiller.Adj | used to adjust initial bias value | [0, 1] |
| WeightFiller.Type | 'zero', 'uniform', 'usni', 'usno', 'usnio', 'usnf', 'gaussian', 'gsni', 'gsno', 'gsnio', 'gsnf' | 'gsni' |
| WeightFiller.Adj | used to adjust initial weight value | [0, 0.8] |
| Image.Draw | draw current image or not | false |
| Image.Adj | used to adjust pixel value | [0.5, 255] |
